...
#
# from mymoney.accounts import BankAccountFactory
...
#         cls.account = BankAccountFactory(currency='USD', owners=[cls.user])
#         cls.banktransaction = BankTransactionFactory(account=cls.account)
...
#         account = BankAccountFactory(currency='USD', owners=[self.user])
#         banktransaction = BankTransactionFactory(
#             account=account,
#             amount=10,
#         )
...
#         account = BankAccountFactory(currency='EUR', owners=[self.user])
#         banktransaction = BankTransactionFactory(
#             account=account,
#             amount=10,
#         )
...
#             'label': 'foo',
#             'amount': 10,
#             'account': BankAccountFactory().pk,
#         })
#         self.assertEqual(response.status_code, 201)
#         banktransaction = Transaction.objects.get(pk=response.data['id'])
#         self.assertEqual(banktransaction.account, self.account)
#
...
#         self.assertEqual(banktransaction.currency, self.account.currency)
#
...
#     def setUpTestData(cls):
#         cls.user = UserFactory(user_permissions='all')
#         cls.account = BankAccountFactory(currency='EUR', owners=[cls.user])
#         cls.banktransaction = BankTransactionFactory(account=cls.account)
#         cls.url = reverse('banktransactions:banktransaction-detail', kwargs={
#             'pk': cls.banktransaction.pk,
#         })
...
#         banktransaction = BankTransactionFactory(account=self.account)
#         url = reverse('banktransactions:banktransaction-detail', kwargs={
#             'pk': banktransaction.pk,
#         })
#         self.client.force_authenticate(self.user)
...
#         account = BankAccountFactory(balance=0, owners=[self.user])
#         banktransaction = BankTransactionFactory(
#             account=account,
#             amount='10',
#             status=Transaction.STATUS_INACTIVE,
...
#     def setUpTestData(cls):
#         cls.user = UserFactory(user_permissions='all')
#         cls.account = BankAccountFactory(owners=[cls.user])
#         cls.banktransaction = BankTransactionFactory(account=cls.account)
#         cls.url = reverse('banktransactions:banktransaction-detail', kwargs={
#             'pk': cls.banktransaction.pk,
#         })
...
#             BankTransactionFactory(account=self.account)
#
#         self.client.force_authenticate(self.user)
#         response = self.client.get(self.url)
#         self.assertEqual(response.status_code, 200)
...
#         bt = BankTransactionFactory(account=self.account)
...
#         bt1 = BankTransactionFactory(account=self.account, label='foObar')
#         bt2 = BankTransactionFactory(account=self.account, label='barfOo')
#         bt3 = BankTransactionFactory(account=self.account, label='foO')
#         BankTransactionFactory(account=self.account, label='baz')
#
#         self.client.force_authenticate(self.user)
...
#         account = BankAccountFactory(balance_initial=0, owners=[self.user])
#         url = reverse('banktransactions:banktransaction-list', kwargs={
#             'bankaccount_pk': account.pk,
#         })
#         BankTransactionFactory(
#             account=account,
#             amount=10,
...
#         account = BankAccountFactory(balance_initial=15, owners=[self.user])
#         url = reverse('banktransactions:banktransaction-list', kwargs={
#             'bankaccount_pk': account.pk,
#         })
#         BankTransactionFactory(
...
#         account = BankAccountFactory(balance_initial=10, owners=[self.user])
#         url = reverse('banktransactions:banktransaction-list', kwargs={
#             'bankaccount_pk': account.pk,
#         })
#         BankTransactionFactory(
...
#                 'bankaccount_pk': self.account.pk})
#         )
#         self.assertEqual(response.status_code, 403)
#
#     def test_access_not_owner_with_permissions(self):
...
#         bt1 = BankTransactionFactory(account=self.account)
#         bt2 = BankTransactionFactory()
#         self.client.force_authenticate(self.user)
#         response = self.client.patch(self.url, data={
#             'ids': [bt1.pk, bt2.pk],
...
#         bt = BankTransactionFactory(account=self.account, amount=20)
#
#         self.client.force_authenticate(self.user)
#         response = self.client.patch(self.url, data={
#             'ids': [bt.pk],
...
#         bt1 = BankTransactionFactory(account=self.account, reconciled=True)
#         bt2 = BankTransactionFactory(account=self.account, reconciled=False)
#
#         self.client.force_authenticate(self.user)
#         response = self.client.patch(self.url, data={
#             'ids': [bt1.pk, bt2.pk],
...
#         bt = BankTransactionFactory(account=self.account, reconciled=False)
#         self.client.force_authenticate(self.user)
#         response = self.client.patch(self.url, data={
#             'ids': [bt.pk],
#             'reconciled': 1,
...
#         bt = BankTransactionFactory(account=self.account, reconciled=True)
#         self.client.force_authenticate(self.user)
#         response = self.client.patch(self.url, data={
#             'ids': [bt.pk],
#             'reconciled': 0,
...
#         bt1 = BankTransactionFactory(account=self.account)
#         bt2 = BankTransactionFactory(account=self.account)
#
#         self.client.force_authenticate(self.user)
#         response = self.client.delete(self.url, data={
#             'ids': [bt1.pk, bt2.pk],
...
#
#     def test_balance_total(self):
#         account = BankAccountFactory(owners=[self.user])
